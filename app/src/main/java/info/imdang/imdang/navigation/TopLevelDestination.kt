...
enum class TopLevelDestination(
    ...
    WRITE(
        selectedIconId = ComponentR.drawable.pen_fill,
        unselectedIconId = ComponentR.drawable.pen_fill,
    ...
    STORAGE(
        selectedIconId = ComponentR.drawable.file,
        unselectedIconId = ComponentR.drawable.file,
